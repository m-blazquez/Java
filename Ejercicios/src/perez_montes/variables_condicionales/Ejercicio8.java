...
public class Ejercicio8 {
	...
	public static void main(String[] args) {
		...
		/*
		 * ENUNCIADO: Pedir dos números y decir cual es el mayor o si son iguales.
		 */
		...
		// Determinar si son iguales y, si no lo son, averiguar cuál es el mayor y devolver el resultado
		if (numero1 == numero2) {
